    ...
    <>
      <section className="store-section bg-white">
        <div className="mx-auto max-w-[1440px] px-5 sm:px-10">
          ...
          <h2 className="mt-3 font-display text-4xl font-bold leading-none tracking-[-.02em] text-luxury-black sm:text-5xl">
            {service.keyword}
          </h2>
          ...
          {isSeo ? (
            <div className="mt-10 grid gap-5 md:grid-cols-2">
              <article className="border border-soft-beige bg-cream p-6">
                <p className="font-mono text-[.65rem] font-bold uppercase tracking-[.08em] text-gold-hover">SEO</p>
              ...
              <article className="border border-soft-beige bg-cream p-6">
                <p className="font-mono text-[.65rem] font-bold uppercase tracking-[.08em] text-gold-hover">GEO</p>
      ...
      {story.map((block, index) => (
        <section key={block.heading} className={index % 2 === 0 ? "store-section bg-cream" : "store-section bg-white"}>
          <div className="mx-auto grid max-w-[1440px] items-center gap-10 px-5 sm:px-10 lg:grid-cols-2">
            ...
            <div>
              <p className="font-mono text-xs font-bold uppercase tracking-[.08em] text-gold-hover">Na prática</p>
              <h3 className="mt-3 font-display text-3xl font-bold tracking-[-.02em] text-luxury-black">{block.heading}</h3>
      ...
      <section className="store-section bg-cream">
        <div className="mx-auto grid max-w-[1440px] gap-10 px-5 sm:px-10 lg:grid-cols-2">
          <div>
            <p className="font-mono text-xs font-bold uppercase tracking-[.08em] text-gold-hover">O problema</p>
            <h2 className="mt-3 font-display text-3xl font-bold tracking-[-.02em] text-luxury-black">O que trava o resultado.</h2>
            <p className="mt-5 text-[1.05rem] leading-relaxed text-warm-gray">{service.problem}</p>
          </div>
          <div>
            <p className="font-mono text-xs font-bold uppercase tracking-[.08em] text-gold-hover">A solução</p>
            <h2 className="mt-3 font-display text-3xl font-bold tracking-[-.02em] text-luxury-black">Como a eFcinco resolve.</h2>
      ...
      <section className="store-section bg-white">
        <div className="mx-auto max-w-[1440px] px-5 sm:px-10">
          <p className="font-mono text-xs font-bold uppercase tracking-[.08em] text-gold-hover">Processo</p>
          <h2 className="mt-3 font-display text-4xl font-bold leading-none tracking-[-.02em] text-luxury-black">Do diagnóstico à evolução.</h2>
      ...
      <section className="store-section bg-cream">
        <div className="mx-auto grid max-w-[1440px] gap-10 px-5 sm:px-10 lg:grid-cols-[1.1fr_.9fr]">
          <div>
            <p className="font-mono text-xs font-bold uppercase tracking-[.08em] text-gold-hover">Resultados esperados</p>
            <h2 className="mt-3 font-display text-3xl font-bold tracking-[-.02em] text-luxury-black">O que a operação passa a ter.</h2>
