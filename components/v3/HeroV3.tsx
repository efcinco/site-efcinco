    ...
    <section className="store-hero">
      ...
      <div className="relative mx-auto flex min-h-[inherit] max-w-[1440px] items-end px-5 py-14 sm:px-10 sm:py-20">
        <div className="max-w-2xl text-white">
          <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-gold/60 bg-luxury-black/50 px-4 py-2 text-xs font-bold uppercase tracking-[0.16em] text-gold backdrop-blur">
            <CheckCircle size={14} /> Soluções VTEX para vender mais
          </div>
          <h1 className="font-display text-balance text-5xl font-bold leading-[.95] tracking-[-.06em] sm:text-7xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            <Link href="/#vitrine-servicos" title="Explorar soluções" className="inline-flex items-center gap-2 rounded-full bg-gold px-6 py-3.5 text-sm font-bold text-luxury-black transition hover:bg-gold-hover">
