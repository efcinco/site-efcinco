    ...
    <>
      ...
      <section className="atmosphere py-16 sm:py-20">
        <Container className="prose-custom max-w-3xl">
          ...
          <h1 className="font-display text-4xl tracking-tight text-navy">Política de Privacidade</h1>
          <div className="mt-8 space-y-5 text-base leading-relaxed text-slate">
            ...
            <h2 className="font-display text-2xl text-navy">Dados coletados</h2>
            <p>
            ...
            <h2 className="font-display text-2xl text-navy">Uso das informações</h2>
            <p>
            ...
            <h2 className="font-display text-2xl text-navy">Contato do titular</h2>
            <p>
